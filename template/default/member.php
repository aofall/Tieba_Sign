...
<ul>
<li id="menu_login" class="current" style="color:black">登录</li>
<?php if(!getSetting('block_register')) { ?>
<li id="menu_register" style="color:black">注册</li>
<?php } ?>
</ul>
</div>
...
<p class="copyright">贴吧签到助手 <?php echo VERSION; ?> - Designed by <a href="https://www.ikk.me" target="_blank">kookxiang</a>. 2014 &copy; <a href="http://www.kookxiang.com" target="_blank">KK's Laboratory</a> (<a href="https://ikk.me/donate.html" target="_blank">赞助开发</a>)<?php if(getSetting('beian_no')) echo ' - <a href="http://www.miibeian.gov.cn/" target="_blank" rel="nofollow">'.getSetting('beian_no').'</a>'; ?></p>
